...
class CreateRequestController extends BaseController
{
    ...
    */
        ...
        */
        ...
        foreach( $selected_drivers as $selected_driver){
            // Send notification to the very first driver
             $first_meta_driver = $selected_driver['driver_id'];

            // Send notification to the very first driver
          //  $first_meta_driver = $selected_drivers[0]['driver_id'];
    
            // Add first Driver into Firebase Request Meta
            $this->database->getReference('request-meta/'.$request_detail->id)->set(['driver_id'=>$first_meta_driver,'request_id'=>$request_detail->id,'user_id'=>$request_detail->user_id,'active'=>1, 'request_eta_amount' => $request_params['request_eta_amount'], 'updated_at'=> Database::SERVER_TIMESTAMP]);
    ...
    public function createRequestOld(CreateTripRequest $request)
    {
        /**
        * Check if the user has registred a trip already
        * Validate payment option is available.
        ...
        */
        ...
        $this->database->getReference('request-meta/'.$request_detail->id)->set(['driver_id'=>[23,25],'request_id'=>$request_detail->id,'user_id'=>$request_detail->user_id,'active'=>1,'updated_at'=> Database::SERVER_TIMESTAMP]);
        
        // $this->database->getReference('request-meta/'.$request_detail->id)->set(
        //     [
        //         ['driver_id'=>22,'request_id'=>$request_detail->id,'user_id'=>$request_detail->user_id,'active'=>1,'updated_at'=> Database::SERVER_TIMESTAMP],
        //         ['driver_id'=>25,'request_id'=>$request_detail->id,'user_id'=>$request_detail->user_id,'active'=>1,'updated_at'=> Database::SERVER_TIMESTAMP],
        //         ['driver_id'=>24,'request_id'=>$request_detail->id,'user_id'=>$request_detail->user_id,'active'=>1,'updated_at'=> Database::SERVER_TIMESTAMP],
        //         // ['driver_id'=>24,'request_id'=>$request_detail->id,'user_id'=>$
        //     ]);
